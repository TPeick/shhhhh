package peick.scathapro.eventlisteners;
...
import peick.scathapro.achievements.Achievement;
...
import peick.scathapro.events.BedrockWallDetectedEvent;
import peick.scathapro.events.CrystalHollowsDayStartedEvent;
import peick.scathapro.events.RealDayStartedEvent;
import peick.scathapro.events.ScathaPetDropEvent;
import peick.scathapro.events.TickEvent.CrystalHollowsTickEvent;
import peick.scathapro.events.TickEvent.FirstCrystalHollowsTickEvent;
import peick.scathapro.events.TickEvent.FirstIngameTickEvent;
import peick.scathapro.events.TickEvent.FirstWorldTickEvent;
import peick.scathapro.gui.menus.FakeBanGui;
import peick.scathapro.managers.Config;
import peick.scathapro.miscellaneous.PetDrop;
import peick.scathapro.miscellaneous.enums.OldLobbyAlertTriggerMode;
...
import peick.scathapro.util.NBTUtil;
    ...
    private void checkForDev()
    {
        ...
        if (
            ...
            (
                ...
                &&
                netHandler.getPlayerInfo("peick") != null
            )
        )
        {
