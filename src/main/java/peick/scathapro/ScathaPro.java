...
import peick.scathapro.achievements.AchievementManager;
import peick.scathapro.alerts.alertmodes.AlertModeManager;
import peick.scathapro.alerts.alertmodes.customalertmode.CustomAlertModeManager;
import peick.scathapro.commands.CommandRegistry;
import peick.scathapro.eventlisteners.GuiListeners;
import peick.scathapro.eventlisteners.LoopListeners;
import peick.scathapro.eventlisteners.MiscListeners;
import peick.scathapro.eventlisteners.ScathaProGameplayListeners;
import peick.scathapro.eventlisteners.ScathaProMiscListeners;
import peick.scathapro.eventlisteners.ScathaProTickListeners;
import peick.scathapro.events.ModUpdateEvent;
import peick.scathapro.managers.AchievementLogicManager;
import peick.scathapro.managers.Config;
import peick.scathapro.managers.HypixelModApiManager;
import peick.scathapro.managers.InputManager;
import peick.scathapro.managers.PersistentData;
import peick.scathapro.managers.SaveManager;
import peick.scathapro.managers.UpdateChecker;
import peick.scathapro.miscellaneous.enums.SkyblockArea;
import peick.scathapro.overlay.AlertTitleOverlay;
import peick.scathapro.overlay.Overlay;
import peick.scathapro.parsing.chestguiparsing.ChestGuiParsingManager;
...
@Mod(
    ...
    clientSideOnly = true,
    guiFactory = "peick.scathapro.ForgeConfigGuiFactory"
)
